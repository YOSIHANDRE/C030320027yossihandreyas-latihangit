      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php
            $menu_master1 = array('mahasiwa', 'mahasiswa_detil', 'mahasiswa_tambah', 'mahasiswa_edit');
            $menu_master2 = array('ukm', 'ukm_tambah', 'ukm_edit');
            $menu_master3 = array('anggota_ukm', 'anggotaukm_tambah', 'anggotaukm_edit');
            ...
            ">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url('admin/anggota_ukm'); ?>" class="nav-link
                    <?php
